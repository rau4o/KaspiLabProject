...
class CircleBarController: UITabBarController {
    ...
    open override var selectedViewController: UIViewController? {
        willSet {
            ...
            guard let tabBar = tabBar as? CircleBar, let index = viewControllers?.index(of: newValue) else {return}
    ...
    open override var selectedIndex: Int {
        willSet {
            ...
            guard let tabBar = tabBar as? CircleBar else {
                return
            }
