...
public struct CustomTabbarSetting {
    ...
    public static var tabBarTintColor: UIColor = #colorLiteral(red: 0.1764705926, green: 0.4980392158, blue: 0.7568627596, alpha: 1)
    public static var tabBarBackground: UIColor = UIColor.mainBlue
